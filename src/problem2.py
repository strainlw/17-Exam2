...
class Triangle(object):
    ...
    def shrink_or_expand(self, f):
        ...
        if after > self.largest:
            self.largest = self.largest + after - self.largest
    ...
    def return_doubled_triangle(self):
        ...
        #        They include the Example in the above doc-string.
        # -------------------------------------------------------------------------
        dt = Triangle(Point(self.a.x*2,self.a.y*2), Point(self.b.x*2, self.b.y*2), Point(self.c.x*2, self.c.y*2))
        return dt
